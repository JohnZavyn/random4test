...
import static com.threeleaf.test.random.util.TestMapUtil.randomMapSingle;
...
public class TestMap
{
    ...
    public static final Map<Integer, Integer> MAP_INTEGER_SINGLE = unmodifiableMap(randomMapSingle(Integer.class, Integer.class));
    ...
    public static final Map<Integer, String> MAP_INTEGER_STRING_SINGLE = unmodifiableMap(randomMapSingle(Integer.class, String.class));
    ...
    public static final Map<Long, Long> MAP_LONG_SINGLE = unmodifiableMap(randomMapSingle(Long.class, Long.class));
    ...
    public static final Map<Long, String> MAP_LONG_STRING_SINGLE = unmodifiableMap(randomMapSingle(Long.class, String.class));
    ...
    public static final Map<Object, Object> MAP_OBJECT_SINGLE = unmodifiableMap(randomMapSingle(Object.class, Object.class));
    ...
    public static final Map<String, String> MAP_STRING_SINGLE = unmodifiableMap(randomMapSingle(String.class, String.class));
}
