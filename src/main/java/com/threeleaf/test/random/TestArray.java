...
import static com.threeleaf.test.random.util.TestArrayUtil.randomArraySingle;
...
public class TestArray
{
    ...
    public static final Integer[] ARRAY_INTEGER_SINGLE = randomArraySingle(Integer.class);

    /** An {@link Long} array. */
    public static final Long[] ARRAY_LONG = randomArrayOf(Long.class);

    /** An {@link Long} array with a single value. */
    public static final Long[] ARRAY_LONG_SINGLE = randomArraySingle(Long.class);
    ...
    public static final Object[] ARRAY_OBJECT_SINGLE = randomArraySingle(Object.class);
    ...
    public static final String[] ARRAY_STRING_SINGLE = randomArraySingle(String.class);
}
