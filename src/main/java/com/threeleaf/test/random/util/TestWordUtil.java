...
public final class TestWordUtil {
    ...
    public static final Set<String> WORDS_ADJECTIVES = ImmutableSet.copyOf((
    ...
    public static final Set<String> WORDS_ADVERBS = ImmutableSet.copyOf((
                                                                        ...
                                                                        ).split(REGEX_PUNCTUATION));

    /** A Set of unique nouns. */
    public static final Set<String> WORDS_NOUNS = ImmutableSet.copyOf((
    ...
    public static final Set<String> WORDS_VERBS = ImmutableSet.copyOf((
