...
public class TestNumber
{
    ...
    public static final BigDecimal BIG_DECIMAL_SMALL = valueOf(randomBetween(1, 10000) / 100D).setScale(2, ROUND_HALF_UP);
    ...
    public static final BigInteger BIG_INTEGER_SMALL = BigInteger.valueOf(randomBetween(0, 100));
    ...
    public final static Byte BYTE_SMALL = (byte) randomBetween(0, 100);
    ...
    public final static Double DOUBLE_SMALL = randomBetween(0, 10000) / 100D;
    ...
    public final static Float FLOAT_SMALL = randomBetween(0, 10000) / 100F;
    ...
    public final static Long LONG_SMALL = (long) randomBetween(0, 100);
    ...
    public final static Short SHORT_SMALL = (short) randomBetween(0, 100);
}
