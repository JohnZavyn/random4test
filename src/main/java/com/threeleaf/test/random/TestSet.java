...
import static com.threeleaf.test.random.util.TestSetUtil.randomSetSingle;
...
public class TestSet
{
    ...
    public static final Set<Integer> SET_INTEGER_SINGLE = unmodifiableSet(randomSetSingle(Integer.class));

    /** An {@link Long} set. */
    public static final Set<Long> SET_LONG = unmodifiableSet(randomSetOf(Long.class));

    /** An {@link Long} set with a single value. */
    public static final Set<Long> SET_LONG_SINGLE = unmodifiableSet(randomSetSingle(Long.class));

    /** An {@link Object} set. */
    public static final Set<Object> SET_OBJECT = unmodifiableSet(randomSetOf(Object.class));

    /** An {@link Object} set with a single value. */
    public static final Set<Object> SET_OBJECT_SINGLE = unmodifiableSet(randomSetSingle(Object.class));

    /** An {@link String} set. */
    public static final Set<String> SET_STRING = unmodifiableSet(randomSetOf(String.class));

    /** An {@link String} set with a single value. */
    public static final Set<String> SET_STRING_SINGLE = unmodifiableSet(randomSetSingle(String.class));
}
